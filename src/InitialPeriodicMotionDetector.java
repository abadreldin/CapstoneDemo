...
public class InitialPeriodicMotionDetector {
    ...
    public void adjustFirstPeriodicMovement(){
        double temp = this.firstPeriodicMovement[this.firstPeriodicMovement.length - 1];
        for(int i = this.firstPeriodicMovement.length - 1; i > 0; i--){
            this.firstPeriodicMovement[i] = this.firstPeriodicMovement[i-1];
        }
        this.firstPeriodicMovement[0] = temp;
    }
